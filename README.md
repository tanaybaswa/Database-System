An implementation of an efficient and lightweight database system that utilises B+ tree indices, efficient join algorithms, query optimization, multigranularity locking to support concurrent execution of transactions, and database recovery. 
